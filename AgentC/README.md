...
AgentC是一个基于大语言模型的智能对话系统平台，支持多种LLM服务商，提供灵活易用的API接口。
...
# 或者通过命令行参数启动
java -jar AgentC.jar --SILICONFLOW_API_KEY=你的API密钥 --SILICONFLOW_MODEL=llama3
```
...
```bash
git clone https://github.com/xhyqaq/AgentC
cd AgentC
```
